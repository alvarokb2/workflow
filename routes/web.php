...
Route::get('/valida_dic', 'IniciativaController@validar_dic');

// Validacion_ei get post true,false
Route::get('/valida_dic', 'IniciativaController@validar_ei');

// Publicar true,false
Route::get('/publicar', 'IniciativaController@publicar');
